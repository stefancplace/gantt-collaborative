...
var ExamplesApp = /*#__PURE__*/function () {
  function ExamplesApp() {
    ...
    var me = this,
      ...
      data: examples,
      fields: ['folder', 'rootFolder', 'fullFolder', 'group', 'title', 'version', 'build', 'since', 'offline', 'ie', 'edge', 'id'],
      groupers: [{
        field: 'group',
        fn: function fn(a, b) {
    ...
    var toolbar = new Toolbar({
      ...
      items: {
        ...
        upgradeButton: {
          ...
          icon: 'b-fa-book',
          width: '12.5em',
          href: me.isOnline ? "/docs/".concat(shared.productName === 'schedulerpro' ? 'scheduler-pro' : shared.productName, "#upgrade-guide") : '../docs#upgrade-guide'
        },
        docsButton: {
          id: 'docs-button',
          type: 'button',
          ...
          icon: 'b-fa-book-open',
          width: '12.5em',
          href: me.isOnline ? "/docs/".concat(shared.productName === 'schedulerpro' ? 'scheduler-pro' : shared.productName) : '../docs'
        },
