import { Store, AjaxHelper, BrowserHelper, DomHelper, DomSync, EventHelper, Toolbar, Popup, Widget, GlobalEvents, VersionHelper } from '../../../build/gantt.module.js?447014';
        ...
        const toolbar = new Toolbar({
            ...
            items : {
                ...
                upgradeButton : {
                    ...
                    icon  : 'b-fa-book',
                    width : '12.5em',
                    href  : me.isOnline ? `/docs/${shared.productName === 'schedulerpro' ? 'scheduler-pro' : shared.productName}#upgrade-guide` : '../docs#upgrade-guide'
                },
                docsButton : {
                    id    : 'docs-button',
                    type  : 'button',
                    ...
                    icon  : 'b-fa-book-open',
                    width : '12.5em',
                    href  : me.isOnline ? `/docs/${shared.productName === 'schedulerpro' ? 'scheduler-pro' : shared.productName}` : '../docs'
                },
