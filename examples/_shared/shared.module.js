import { LocaleManager, Localizable, AsyncHelper, AjaxHelper, DomHelper, Button, Popup, Tooltip, Toast, Widget, BrowserHelper, EventHelper, ResizeHelper, VersionHelper, DataGenerator, Fullscreen, Events, GlobalEvents, Rectangle } from '../../build/gantt.module.js?447014';
// Load localization
...
const
    ...
    productName          = 'gantt', // PRODUCT NAME (DON'T CHANGE OR REMOVE !!!)
    productFullName      = 'Bryntum Gantt', // PRODUCT FULL NAME (DON'T CHANGE OR REMOVE !!!)
    ...
    isModule             = pathName.endsWith('module.html') || (moduleTag && moduleTag.src.includes('app.module.js?447014')) || (pathName.endsWith('index.html') && isOnline),
...
class CodeEditor extends Popup {
            ...
            tbar : [
                {
                    ...
                    ref      : 'filesCombo',
                    editable : false,
                    value    : isModule ? 'app.module.js?447014' : isUmd ? 'app.umd.js?447014' : 'app.js?447014',
                    items    : [
                        isModule ? 'app.module.js?447014' : isUmd ? 'app.umd.js?447014' : 'app.js?447014'
                    ],
    ...
    async loadCode(filename = isModule ? 'app.module.js?447014' : isUmd ? 'app.umd.js?447014' : 'app.js?447014') {
        const
            me = this;
        ...
        if (filename.endsWith('.js?447014')) {
            me.mode = 'js';
            code = me.processJS(code);
        }
        else if (filename.endsWith('.css?447014')) {
            me.mode = 'css';
    ...
    updateDownloadLink() {
        ...
        downloadLink.href = `data:text/${this.filename.endsWith('.css?447014') ? 'css' : 'javascript'};charset=utf-8,${escape(this.codeElement.innerText)}`;
    }
    ...
    static async addToPage(button) {
        ...
        if (document.head.querySelector('[href$="app.css?447014"]')) {
            filesStore.add({
                text  : 'resources/app.css?447014',
                value : 'resources/app.css?447014'
            });
        }
