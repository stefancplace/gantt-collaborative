...
window.examples = [
    ...
    { folder : 'bigdataset', group : 'Intermediate', title : 'Big data set', since : '4.0' },
    ...
    { folder : 'custom-rendering', group : 'Intermediate', title : 'Customizing task bar contents', since : '4.0' },
    { folder : 'custom-taskmenu', group : 'Intermediate', title : 'Replace the task menu', since : '4.0' },
    { folder : 'esmodule', group : 'Integration', title : 'Include using EcmaScript module' },
    { folder : 'extjsmodern', group : 'Integration', title : 'ExtJS Modern App integration demo', version : 'ExtJS 6.5.3', since : '1.0.2' },
    { folder : 'gantt-schedulerpro', group : 'Intermediate', title : 'Gantt + Scheduler Pro', since : '4.0' },
    ...
    { folder : 'msprojectexport', group : 'Advanced', title : 'Export to MS Project', since : '4.0' },
    ...
    { folder : 'react/typescript/sharepoint-fabric', group : 'Integration/React', title : 'React SharePoint Workbench demo with TypeScript', version : 'React 16', build : true, offline : true, since : '4.0.4' },
    ...
    { folder : 'resourcehistogram', group : 'Advanced', title : 'Gantt with resource histogram demo', since : '4.0' },
    ...
    { folder : 'taskmenu', group : 'Intermediate', title : 'Customizing the task menu' },
    ...
    { folder : 'vue/javascript/taskeditor', group : 'Integration/Vue', title : 'Vue Task editor customization demo', version : 'Vue 2', build : true, since : '2.0.1' },
    { folder : 'vue/javascript/timeranges', group : 'Integration/Vue', title : 'Vue Time ranges demo', version : 'Vue 2', build : true, since : '2.0.1' },
