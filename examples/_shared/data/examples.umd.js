...
window.examples = [{
  ...
  folder: 'react/typescript/sharepoint-fabric',
  group: 'Integration/React',
  title: 'React SharePoint Workbench demo with TypeScript',
  version: 'React 16',
  build: true,
  offline: true,
  since: '4.0.4'
  ...
  group: 'Advanced',
  title: 'Gantt with resource histogram demo',
  since: '4.0'
}, {
  folder: 'responsive',
  group: 'Basic',
  ...
  group: 'Integration/Vue',
  title: 'Vue Task editor customization demo',
  version: 'Vue 2',
  build: true,
  since: '2.0.1'
}, {
