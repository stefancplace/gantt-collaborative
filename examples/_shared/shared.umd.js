...
var _bryntum$gantt = bryntum.gantt,
    ...
    AsyncHelper = _bryntum$gantt.AsyncHelper,
    ...
    Rectangle = _bryntum$gantt.Rectangle; // Load localization
...
'/grid/', // On bryntum.com...
'/scheduler/', '/scheduler-pro/', '/gantt/', '/calendar/'],
    themes = {
  stockholm: 'Stockholm',
  classic: 'Classic',
